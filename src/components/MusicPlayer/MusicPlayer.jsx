...
const MusicPlayer = ({ id, srcaudio }) => {
  ...
  return (
    <Navbar
      fixed="bottom"
      className="justify-content-center text-white bg-dark"
      ...
      <div className="music-player d-flex justify-content-around">
        ...
        <div className="d-flex flex-column">
          ...
          <div className="d-flex align-items-center">
            ...
            <input type="range" className="mb-3 main-slider" value={trackProgress} />
        ...
        >
          ...
          <input type="range" className="volume-slider" value={trackProgress} />
        </div>
