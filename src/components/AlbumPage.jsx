...
import { playPause, setCurrentSongAction, setQueueAction, removeAlbumFromFavouritesAction, addAlbumToFavouritesAction } from "../redux/actions";
        ...
        <Row className="ml-5">
          <Col>
           ...
           {!media.play &&<svg
            ...
            {favourites.albums.find((item) => item.id === album?.id) ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              height="30"
              ...
              viewBox="0 0 16 16"
              onClick={() =>
                dispatch(removeAlbumFromFavouritesAction(album))
              }
            >
              <path
                fill-rule="evenodd"
            ...
            <svg
              ...
              fill="currentColor"
              onClick={() =>
                dispatch(addAlbumToFavouritesAction(album))
              }
